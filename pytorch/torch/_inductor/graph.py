...
class GraphLowering(torch.fx.Interpreter):
    ...
    def __init__(
        ...
        lifted_input_tensors: Optional[Sequence[torch.Tensor]] = None,
    ) -> None:
        super().__init__(gm)
        ...
        self.static_input_idxs = tuple(static_input_idxs or ())
        self.lifted_input_tensors = tuple(lifted_input_tensors or ())
        ...
        self.chipyard_deferred_autotune_sites: list[dict[str, Any]] = []
        self.chipyard_deferred_autotune_sites_by_id: dict[str, dict[str, Any]] = {}
        self.chipyard_deferred_autotune_sites_by_key: dict[str, dict[str, Any]] = {}
        self.chipyard_deferred_autotune_choice_callers: dict[str, list[Any]] = {}
        self.chipyard_deferred_autotune_site_counter = 0
