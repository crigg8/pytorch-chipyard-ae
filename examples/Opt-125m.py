...
TASK_NAME = "opt-125m"
MODEL_NAME = "transformers.OPTConfig"
DTYPE = torch.float32
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compile or validate OPT-125M Chipyard artifacts.")
...
def build_config(attn: str) -> OPTConfig:
    config = OPTConfig()
...
def make_random_inputs(batch_size: int, seed: int, config: OPTConfig) -> dict[str, torch.Tensor]:
