...
public:
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    ShapedType inputShapeType = mlir::cast<ShapedType>(input.getType());
    ShapedType filterShapeType = mlir::cast<ShapedType>(kernel.getType());
    ShapedType outputShapeType = mlir::cast<ShapedType>(output.getType());
