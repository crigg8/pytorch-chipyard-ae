...
extern "C" LLVM_ABI LLVM_EXTERNAL_VISIBILITY void LLVMInitializeRISCVTarget() {
  ...
  initializeRISCVRVVBaseHazardPass(*PR);
  initializeRISCVRVVStoreFencePass(*PR);
...
void RISCVPassConfig::addPreEmitPass2() {
  ...
  // Drain Saturn RVV stores before a younger scalar definition can reuse the
  // physical register containing the store base.
  addPass(createRISCVRVVStoreFencePass());
...
void RISCVPassConfig::addPreRegAlloc() {
  ...
  addPass(createRISCVRVVBaseHazardPass());
