...
FunctionPass *createRISCVRVVBaseHazardPass();
void initializeRISCVRVVBaseHazardPass(PassRegistry &);

FunctionPass *createRISCVRVVStoreFencePass();
void initializeRISCVRVVStoreFencePass(PassRegistry &);
